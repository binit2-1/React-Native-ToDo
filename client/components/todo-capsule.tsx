      ...
      return (
        <View 
          ...
          className={cn(
            ...
            isFinished ? "h-28 bg-yellow-200" : "bg-white py-4"
          )}
        >
          {isFinished ? (
                ...
                {todo.assignees && todo.assignees.length > 0 && (
                  <View className="flex flex-row items-center">
                    {todo.assignees.slice(0, 3).map((assignee, index) => (
                      ...
                      >
                        <Avatar className="h-8 w-8" alt={`Assignee ${index + 1}`}>
                    ...
                    {todo.assignees.length > 3 && (
                      <View
                        className={cn(
                          "rounded-full border-2 border-white bg-red-500 items-center justify-center -ml-2",
                          "h-8 w-8"
                        )}
                        style={{ zIndex: 0 }}
                      >
              ...
              <View className="flex flex-row justify-between items-center">
                <View className="flex flex-row gap-2">
                  <View className="bg-gray-100 px-2 py-1 rounded-lg">
                    <Text className="font-google-sans-flex-9pt-regular text-xs text-gray-600">
                      Today
                    </Text>
                  </View>
                  <View className="bg-gray-100 px-2 py-1 rounded-lg">
                ...
                <View className="flex h-10 w-10 bg-black rounded-full items-center justify-center">
